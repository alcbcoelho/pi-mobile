...
import {
  unreadNotifications,
  allNotifications as allNotifications_,
} from "../mockup/NotificationsData";
          ...
          <View style={global.item}>
            ...
            <ScrollView>
              ...
              <Text variant="labelMedium">
                {item.foundObject}, achado por {item.user}, corresponde ao seu
                objeto perdido {item.lostObject}
              </Text>
            </ScrollView>
          </View>
          <Divider />
